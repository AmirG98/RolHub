    ...
    <article className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <nav className="mb-8" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 text-sm font-ui text-parchment">
          <li><Link href="/" className="hover:text-gold-bright">Inicio</Link></li>
          <li className="text-parchment-dark">/</li>
          <li><Link href="/guias" className="hover:text-gold-bright">Guias</Link></li>
          <li className="text-parchment-dark">/</li>
          <li className="text-gold-bright font-semibold">Que es un Juego de Rol</li>
        </ol>
      </nav>
      ...
      <ParchmentPanel className="p-6 mb-12 border border-gold-dim">
        <h2 className="font-heading text-lg text-ink mb-4">Contenido de esta guia</h2>
      ...
      <div className="prose prose-invert prose-gold max-w-none">
        ...
        <section id="definicion" className="mb-16 scroll-mt-20">
          ...
          <div className="font-body text-parchment space-y-4 text-lg leading-relaxed">
            <p>
              Un <strong className="text-gold-bright">juego de rol</strong> (tambien conocido como <strong>RPG</strong> por sus siglas en ingles,
            ...
            <ul className="space-y-2">
              <li><strong className="text-gold-bright">Rol de mesa:</strong> El formato tradicional con dados, fichas de personaje y un grupo reunido (presencial u online).</li>
              <li><strong className="text-gold-bright">Rol en vivo (LARP):</strong> Los participantes interpretan fisicamente a sus personajes, como teatro interactivo.</li>
              <li><strong className="text-gold-bright">Rol con IA:</strong> Plataformas como RolHub donde una inteligencia artificial actua como Director de Juego.</li>
            </ul>
          </div>
        </section>
          ...
          <div className="font-body text-parchment space-y-4 text-lg leading-relaxed">
            ...
            <ol className="space-y-4 list-none pl-0">
              <li className="flex gap-4">
                <span className="font-heading text-gold-bright text-xl flex-shrink-0">1.</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="font-heading text-gold-bright text-xl flex-shrink-0">2.</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="font-heading text-gold-bright text-xl flex-shrink-0">3.</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="font-heading text-gold-bright text-xl flex-shrink-0">4.</span>
                <div>
          ...
          <div className="font-body text-parchment space-y-6 text-lg leading-relaxed">
            ...
            <div>
              ...
              <p>
                ...
                <Link href="/guias/crear-personaje" className="text-gold-bright hover:text-gold font-semibold"> guia de creacion de personajes</Link>.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                <Link href="/guias/mejores-mundos" className="text-gold-bright hover:text-gold font-semibold"> mundos pre-construidos</Link> como
        ...
        <section id="mitos" className="mb-16 scroll-mt-20">
          ...
          <div className="font-body text-parchment space-y-6 text-lg leading-relaxed">
            ...
            <div className="border-l-4 border-blood pl-4">
              <p className="text-blood font-heading font-bold">&ldquo;Los juegos de rol son solo para nerds&rdquo;</p>
            ...
            <div className="border-l-4 border-blood pl-4">
              <p className="text-blood font-heading font-bold">&ldquo;Necesitas muchas horas libres&rdquo;</p>
              <p className="text-parchment mt-2">
                <strong>No necesariamente.</strong> Existen formatos cortos llamados &ldquo;one-shots&rdquo; de 1-2 horas.
                En <Link href="/onboarding" className="text-gold-bright hover:text-gold font-semibold">RolHub</Link> puedes jugar sesiones de 30-60 minutos a tu ritmo.
              </p>
            </div>

            <div className="border-l-4 border-blood pl-4">
              <p className="text-blood font-heading font-bold">&ldquo;Es complicado aprender&rdquo;</p>
              <p className="text-parchment mt-2">
            ...
            <div className="border-l-4 border-blood pl-4">
              <p className="text-blood font-heading font-bold">&ldquo;Necesitas un grupo de amigos que jueguen&rdquo;</p>
              <p className="text-parchment mt-2">
        ...
        <section id="empezar" className="mb-16 scroll-mt-20">
          ...
          <div className="font-body text-parchment space-y-4 text-lg leading-relaxed">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/guias/como-jugar" className="text-gold-bright hover:text-gold font-semibold">
                  → Como Jugar en RolHub: Tutorial Paso a Paso
                </Link>
              </li>
              <li>
                <Link href="/guias/crear-personaje" className="text-gold-bright hover:text-gold font-semibold">
                  → Como Crear tu Primer Personaje
                </Link>
              </li>
              <li>
                <Link href="/guias/mejores-mundos" className="text-gold-bright hover:text-gold font-semibold">
                  → Los Mejores Mundos para Principiantes
                </Link>
              </li>
            </ul>

            <ParchmentPanel variant="ornate" className="p-8 my-8 text-center border-2 border-gold">
      ...
      <section className="mb-12">
        <h2 className="font-heading text-xl text-gold-bright mb-6">Articulos Relacionados</h2>
      ...
      {/* Navigation */}
      <nav className="border-t border-gold/30 pt-8 mt-12" aria-label="Navegacion de articulos">
