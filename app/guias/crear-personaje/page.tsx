      ...
      <div className="prose prose-invert prose-gold max-w-none">
          ...
          <div className="font-body text-parchment/90 space-y-4 text-lg leading-relaxed">
            ...
            <div className="grid gap-4 my-8">
              <ParchmentPanel className="p-5">
                <h3 className="font-heading text-lg text-gold-dim mb-2">Que tipo de heroe quieres ser?</h3>
              ...
              <ParchmentPanel className="p-5">
                <h3 className="font-heading text-lg text-gold-dim mb-2">Cual es su motivacion?</h3>
                <p className="font-body text-ink/80 text-base">
              ...
              <ParchmentPanel className="p-5">
                <h3 className="font-heading text-lg text-gold-dim mb-2">Cual es su debilidad?</h3>
                <p className="font-body text-ink/80 text-base">
            ...
            <ParchmentPanel variant="ornate" className="p-6 my-8">
              <p className="font-body text-ink/90 italic text-center">
              ...
              {archetypes.map((arch) => (
                <ParchmentPanel key={arch.name} className="p-6">
                  <div className="flex items-start gap-4">
                    <div className="p-3 rounded-lg bg-gold-dim/20 text-gold-dim">
                      <arch.icon className="h-6 w-6" />
                    </div>
                    <div className="flex-1">
                      <h3 className="font-heading text-xl text-gold-dim mb-2">{arch.name}</h3>
                      <p className="font-body text-ink/90 mb-3">{arch.description}</p>
                      <p className="font-body text-ink/60 text-sm mb-2">
                        <strong className="text-ink/80">Ejemplos:</strong> {arch.examples}
                      </p>
                      <p className="font-body text-emerald text-sm">
                        {arch.playstyle}
                      </p>
                    </div>
                  </div>
          ...
          <div className="font-body text-parchment/90 space-y-4 text-lg leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-4 my-6">
              <ParchmentPanel className="p-4">
                <h4 className="font-heading text-gold-dim mb-2">Si</h4>
                <ul className="font-body text-ink/80 text-base space-y-1">
              ...
              <ParchmentPanel className="p-4">
                <h4 className="font-heading text-gold-dim mb-2">Evita</h4>
                <ul className="font-body text-ink/80 text-base space-y-1">
        ...
        <section className="mb-16">
          ...
          <div className="font-body text-parchment/90 space-y-4 text-lg leading-relaxed">
            ...
            <ParchmentPanel className="p-5 my-8">
              <h4 className="font-heading text-gold-dim mb-3">Ejemplo Rapido</h4>
              <p className="font-body text-ink/80 italic">
              ...
              <p className="font-body text-ink/60 text-sm mt-3">
        ...
        <section className="mb-16">
          ...
          <div className="font-body text-parchment/90 space-y-4 text-lg leading-relaxed">
            ...
            <ParchmentPanel variant="ornate" className="p-6 my-8">
              <p className="font-body text-ink/90 text-center">
