...
const archetypes = [
  {
    ...
    examples: 'el heredero oculto de las sagas épicas, el bárbaro indomable, Brienne de Tarth',
  ...
  },
  {
    ...
    examples: 'el arquero élfico, Lara Croft, el contrabandista astuto de las space operas',
  ...
  },
  {
    ...
    examples: 'Olvar, Doctor Strange, Yennefer',
        ...
        <section className="mb-16">
          ...
          <div className="font-body text-parchment space-y-4 text-lg leading-relaxed">
            ...
            <div className="grid gap-6 my-8">
              {archetypes.map((arch) => (
                <ParchmentPanel key={arch.name} className="p-6 border border-gold-dim">
                  <div className="flex items-start gap-4">
                    <div className="p-3 rounded-lg bg-stone text-gold-bright">
          ...
          <div className="font-body text-parchment space-y-4 text-lg leading-relaxed">
            ...
            <ol className="space-y-4 list-none pl-0 my-6">
              <li className="flex gap-4">
                <span className="font-heading text-gold-bright text-xl">1.</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="font-heading text-gold-bright text-xl">2.</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="font-heading text-gold-bright text-xl">3.</span>
                <div>
        ...
        <section className="mb-16">
          ...
          <div className="font-body text-parchment space-y-4 text-lg leading-relaxed">
            ...
            <ol className="space-y-4 list-none pl-0 my-6">
              ...
              <li className="flex gap-4">
                <span className="font-heading text-gold-bright text-xl">4.</span>
                <div>
