...
export default function HomePage() {
  ...
  // CTA primario depende del estado de auth
  const primaryHref  = isSignedIn ? '/campaigns' : '/onboarding'
  const primaryLabel = isSignedIn ? t.home.continuePlaying : t.home.startAdventure
    ...
    <div className="min-h-[85vh] flex items-center justify-center particle-bg px-4 py-8">
      <div className="max-w-4xl mx-auto text-center content-wrapper">
        ...
        <div className="glass-panel-dark rounded-lg p-6 md:p-12 glow-effect">
          ...
          {/* CTA buttons — botón primario condicional, "Jugar sin Cuenta" oculto si está logueado */}
