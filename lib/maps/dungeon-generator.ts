...
const LORE_CONTENT: Record<string, {
  ...
  LOTR: {
    ...
    descriptions: {
      ...
      treasure: ['Una cámara con cofres de lunacero', 'Un altar con ofrendas antiguas'],
  ...
  STAR_WARS: {
    enemies: ['Autómata de batalla', 'Coracero', 'Cazarrecompensas', 'Criatura alienígena', 'Autómata asesino'],
    treasures: ['Cristal Kyber', 'Créditos Imperiales', 'Datos secretos', 'Arma modificada', 'Holocrón'],
    traps: ['Rayo láser', 'Puerta de seguridad', 'Autómata centinela', 'Campo de fuerza'],
    ...
    descriptions: {
      ...
      monster: ['Sonidos de autómatas patrullando', 'Algo acecha en los conductos'],
      ...
      safe: ['Cápsula de escape preparada', 'Sala de meditación Vael'],
      shop: ['Contrabandista con mercancía', 'Autómata vendedor automático'],
      shrine: ['Templo Vael en ruinas', 'Artefactos de la Corriente'],
