...
const GUIDANCE: Record<string, LoreGuidance> = {
  ...
  // Cyberpunk no venía de una franquicia puntual, pero el modelo conoce
  // Cyberpunk 2077 de memoria y lo inventa solo: una partida real (2026-08-31)
  // narró "Arasaka" y "NetWatch" cuatro días después de limpiar los datos.
  CYBERPUNK: {
    es: 'Este es un mundo cyberpunk ORIGINAL llamado Neón y Cromo, en la ciudad de Neon City. USÁ estos nombres propios: Kurotek (megacorporación dominante), Vanguard Arms (corporación armamentista), VigilNet (policía de la Red), MedForce (paramédicos corporativos), Club Limbo (bar de mercenarios), Nyx (la fixer legendaria), los Espectros (gang de netrunners místicos), el Velo Negro (barrera digital que contiene a las IAs), Bahía Argenta (distrito abandonado). PROHIBIDO usar nombres de Cyberpunk 2077 / Cyberpunk 2020: nada de Night City, Arasaka, Militech, NetWatch, Trauma Team, Afterlife, Voodoo Boys, Maelstrom, Tyger Claws, Valentinos, Johnny Silverhand, Adam Smasher, Rogue, Delamain, Blackwall, Pacifica, braindance. Inventá nombres propios en el estilo de ESTE mundo, nunca los del videojuego.',
    en: 'This is an ORIGINAL cyberpunk world called Neon and Chrome, set in Neon City. USE these proper nouns: Kurotek (the dominant megacorp), Vanguard Arms (arms manufacturer), VigilNet (the Net police), MedForce (corporate paramedics), Club Limbo (mercenary bar), Nyx (the legendary fixer), the Espectros (mystic netrunner gang), the Black Veil (digital barrier holding back the AIs), Bahía Argenta (abandoned district). FORBIDDEN to use Cyberpunk 2077 / Cyberpunk 2020 names: no Night City, Arasaka, Militech, NetWatch, Trauma Team, Afterlife, Voodoo Boys, Maelstrom, Tyger Claws, Valentinos, Johnny Silverhand, Adam Smasher, Rogue, Delamain, Blackwall, Pacifica, braindance. Invent proper nouns in THIS world\'s style, never the video game\'s.',
  },
  ROMANTASY: {
