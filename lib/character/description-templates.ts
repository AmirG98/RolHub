...
const TEMPLATES: Record<string, DescriptionTemplate> = {
  ...
  STAR_WARS: {
    ...
    features: [
      ...
      { es: 'una calma que solo da la conexion con la Corriente', en: 'the kind of calm only the Current can give' },
      { es: 'tatuajes de su planeta natal', en: 'tattoos from their home planet' },
    ],
    attitudes: [
      { es: 'Siente las perturbaciones en la Corriente', en: 'Feels the disturbances in the Current' },
    ...
    accessories: [
      { es: 'Un sable laser oculto bajo la tunica', en: 'A plasma blade hidden beneath their tunic' },
      ...
      { es: 'Un casco vhardio abolaldo', en: 'A dented Mandalorian helmet' },
    ],
  },
