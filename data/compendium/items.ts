...
const LOTR_ITEMS: Item[] = [
  {
    slug: 'dardo', name: 'Dardo (Sting)', lore: 'LOTR', loreName: 'Tierra del Ocaso',
    type: 'weapon', rarity: 'rare',
    description: 'Espada corta élfica forjada en Gondolin durante la Primera Edad. Su hoja brilla con luz azul cuando los orcos están cerca, sirviendo como advertencia silenciosa. Fue portada por Talbo y luego por Fero.',
    ...
    imagePrompt: 'elven short sword Sting glowing blue, intricate elvish runes on blade, leather wrapped hilt, dark cave background, classic epic fantasy fantasy oil painting style',
    tags: ['espada', 'élfico', 'orco', 'legendario'],
  },
  {
    slug: 'glamdring', name: 'Glamdring', lore: 'LOTR', loreName: 'Tierra del Ocaso',
    type: 'weapon', rarity: 'legendary',
    description: 'La Espada Martillo de Enemigos, forjada para el Rey Turgon de Gondolin. Brilla con fuego blanco en presencia del mal. Olvar la portó durante la Guerra del Anillo y con ella enfrentó al Balrog.',
    ...
    imagePrompt: 'glamdring elven longsword, white glowing blade with ancient runes, golden hilt with jewels, gandalf weapon, classic epic fantasy epic fantasy painting',
    tags: ['espada', 'élfico', 'gandalf', 'legendario'],
  },
  {
    slug: 'cota-de-lunacero', name: 'Cota de Mithril', lore: 'LOTR', loreName: 'Tierra del Ocaso',
    type: 'armor', rarity: 'legendary',
    description: 'Cota de malla enana forjada en lunacero puro, el metal más precioso de la Tierra del Ocaso. Ligera como una pluma pero más resistente que el acero de dragón. Fue un regalo del Rey Thorin a Talbo.',
    ...
    imagePrompt: 'lunacero chainmail shirt, shimmering silver mesh, incredibly detailed dwarven craftsmanship, glowing faintly, classic epic fantasy fantasy painting',
    tags: ['armadura', 'enano', 'lunacero', 'legendario'],
  },
  {
    slug: 'frasco-de-galadriel', name: 'Frasco de Ithariel', lore: 'LOTR', loreName: 'Tierra del Ocaso',
    type: 'artifact', rarity: 'very-rare',
    description: 'Un frasco de cristal que contiene la luz de Eärendil, la estrella más brillante del cielo. Dado por Ithariel a Fero como luz en los lugares oscuros. Su resplandor ahuyenta a las criaturas de la sombra.',
    ...
    imagePrompt: 'phial of galadriel, crystal vial with brilliant white starlight, ethereal glow illuminating darkness, classic epic fantasy fantasy art, magical light painting',
    tags: ['artefacto', 'luz', 'élfico', 'protección'],
  },
  {
    slug: 'orbe vidente', name: 'Palantír', lore: 'LOTR', loreName: 'Tierra del Ocaso',
    type: 'artifact', rarity: 'legendary',
    description: 'Una de las Piedras Videntes forjadas por Fëanor en Elyndor. Permite ver lugares y personas distantes, y comunicarse con quien posea otra Palantír. Su uso conlleva el riesgo de ser detectado por Malzhur.',
    properties: ['Visión remota: ver cualquier lugar a cualquier distancia', 'Comunicación telepática con otros portadores de Palantír', 'Riesgo: CD 18 WIS o Malzhur detecta al usuario', 'Requiere 1 hora de concentración para activar'],
    weight: '8 lb', value: 'Incalculable',
    imagePrompt: 'orbe vidente seeing stone, dark crystal orb with swirling mist inside, faint orange glow, hands reaching toward it, classic epic fantasy dark fantasy painting',
    tags: ['artefacto', 'visión', 'comunicación', 'peligroso'],
  },
  {
    slug: 'pan del alba', name: 'Lembas', lore: 'LOTR', loreName: 'Tierra del Ocaso',
    ...
    imagePrompt: 'pan del alba bread, golden wafer wrapped in green mallorn leaves, elvish food, soft warm light, classic epic fantasy fantasy still life painting',
    tags: ['comida', 'curación', 'élfico', 'viaje'],
  },
  {
    slug: 'capa-elfica', name: 'Capa Élfica', lore: 'LOTR', loreName: 'Tierra del Ocaso',
    type: 'armor', rarity: 'rare',
    description: 'Capa tejida por los elfos de Aurelion con hilos que cambian de color según el entorno. Quien la porta se mimetiza con su alrededor, volviéndose casi invisible. Un broche en forma de hoja la sujeta.',
    ...
    imagePrompt: 'elven cloak lorien, shimmering grey-green fabric that blends with surroundings, leaf-shaped silver brooch, classic epic fantasy fantasy painting',
    tags: ['capa', 'sigilo', 'élfico', 'protección'],
  },
  {
    slug: 'albahoja', name: 'Albahoja (Hierba del Rey)', lore: 'LOTR', loreName: 'Tierra del Ocaso',
    type: 'consumable', rarity: 'rare',
    description: 'Planta curativa traída a la Tierra del Ocaso por los Númenóreanos. En manos de un verdadero sanador, puede curar heridas envenenadas y el Aliento Negro de los Umbríos. Su fragancia purifica el aire.',
    properties: ['Cura veneno y enfermedad en manos de un sanador', 'Neutraliza el Aliento Negro de los Umbríos', 'Restaura 4d4+4 HP cuando se prepara correctamente', 'Purifica el aire: bonus +2 a salvaciones en el área'],
    weight: '0.1 lb', value: '200 monedas de oro',
    imagePrompt: 'albahoja kingsfoil herb, small white flowers with green leaves, mortar and pestle, healing light, classic epic fantasy botanical fantasy illustration',
...
const STAR_WARS_ITEMS: Item[] = [
  {
    slug: 'plasma blade', name: 'Lightsaber', lore: 'STAR_WARS', loreName: 'space opera',
    type: 'weapon', rarity: 'very-rare',
    description: 'El arma elegante de una era más civilizada. Un hoja de plasma construido por un Vael como parte de su entrenamiento. El cristal cristal de resonancia en su interior define su color y sintoniza con la Corriente de su creador.',
    properties: ['Corta casi cualquier material excepto beskar y cortosis', 'Puede deflectar disparos de blaster (requiere tirada)', 'Daño extra contra usuarios del Lado Oscuro', 'Requiere conexión con la Corriente para máximo potencial'],
    damage: '2d10 radiante + modificador de Fuerza',
    weight: '1 lb', value: 'No tiene precio — se construye, no se compra',
    imagePrompt: 'plasma blade, glowing blue plasma blade, metallic hilt with crystal chamber, dark background, space opera cinematic lighting dramatic',
    tags: ['sable', 'vael', 'fuerza', 'legendario'],
  },
  {
    slug: 'blaster-dl-44', name: 'Blaster DL-44', lore: 'STAR_WARS', loreName: 'space opera',
    type: 'weapon', rarity: 'uncommon',
    ...
    imagePrompt: 'DL-44 blaster pistol, worn metal finish, holster on belt, space opera cantina background, cinematic sci-fi lighting',
    tags: ['blaster', 'pistola', 'contrabandista', 'compacto'],
  },
  {
    slug: 'armadura-vhardia', name: 'Armadura Mandaloriana', lore: 'STAR_WARS', loreName: 'space opera',
    type: 'armor', rarity: 'legendary',
    description: 'Armadura completa forjada en beskar puro, el metal más resistente de la galaxia. Puede resistir impactos de plasma blade y blaster pesado. Para los Mandalorianos, la armadura es más que protección — es identidad.',
    properties: ['AC 20', 'Resistencia a daño de energía y radiante', 'Inmune al corte de plasma blade', 'Casco con HUD: visión nocturna + scanner térmico', 'Sellada: protección ambiental completa'],
    ac: 20,
    weight: '25 lb', value: 'Incalculable — patrimonio vhardio',
    imagePrompt: 'mandalorian beskar armor, full set with T-visor helmet, scratched silver metal, space opera cinematic epic dark lighting',
    tags: ['armadura', 'beskar', 'vhardio', 'legendario'],
  },
  {
    slug: 'holocron', name: 'Holocrón', lore: 'STAR_WARS', loreName: 'space opera',
    type: 'artifact', rarity: 'very-rare',
    description: 'Un dispositivo de almacenamiento de conocimiento Vael o Umbra en forma de cubo o pirámide. Contiene las enseñanzas holográficas de un maestro antiguo. Solo puede abrirlo un usuario de la Corriente sensible.',
    properties: ['Contiene conocimiento de un maestro Vael/Umbra', 'Solo se abre con la Corriente', 'Enseña 1 poder de la Corriente nuevo al interactuar', 'Holocrón Umbra: riesgo de corrupción del Lado Oscuro', 'Proyecta hologramas interactivos del maestro guardián'],
    weight: '1 lb', value: '50.000 créditos en el mercado negro',
    imagePrompt: 'vael holocron, glowing blue crystalline cube, holographic figure emerging, ancient vael temple, space opera mystical lighting',
    tags: ['cripta de memoria', 'fuerza', 'conocimiento', 'vael'],
  },
  {
    slug: 'bacta-tank-portatil', name: 'Bacta Tank Portátil', lore: 'STAR_WARS', loreName: 'space opera',
    type: 'tool', rarity: 'rare',
    ...
    imagePrompt: 'portable bacta tank, compact medical device with blue glowing fluid, space opera military medkit, sci-fi cinematic lighting',
    tags: ['médico', 'bacta', 'curación', 'militar'],
  },
  {
    slug: 'thermal-detonator', name: 'Detonador Termal', lore: 'STAR_WARS', loreName: 'space opera',
    type: 'consumable', rarity: 'rare',
    ...
    imagePrompt: 'thermal detonator, metallic sphere with red activation light, held in gloved hand, space opera cantina tense scene, cinematic lighting',
    tags: ['explosivo', 'área', 'devastador', 'negociación'],
  },
  {
    slug: 'jetpack', name: 'Jetpack', lore: 'STAR_WARS', loreName: 'space opera',
    type: 'tool', rarity: 'uncommon',
    description: 'Mochila propulsora vhardia que permite vuelo vertical y horizontal. Equipada con un lanzamisiles integrado en los modelos de combate. Requiere combustible de cohete y mantenimiento regular.',
    ...
    imagePrompt: 'mandalorian jetpack, worn metal with exhaust flames, flying above desert landscape, space opera cinematic action scene',
    tags: ['vuelo', 'vhardio', 'propulsión', 'combate'],
  },
]
