...
// Hechizos de Tierra Media (LOTR)
const LOTR_SPELLS: Spell[] = [
  {
    slug: 'palabra-de-mando', name: 'Palabra de Mando', lore: 'LOTR', loreName: 'Tierra Media',
    ...
    damage: '4d6 trueno',
    imagePrompt: 'gandalf-like wizard shouting a word of power, shockwave emanating from mouth, enemies flying back, dramatic lighting, tolkien fantasy oil painting',
    tags: ['evocación', 'control', 'área', 'istari'],
  },
  {
    slug: 'luz-de-earendil', name: 'Luz de Eärendil', lore: 'LOTR', loreName: 'Tierra Media',
    ...
    imagePrompt: 'glowing star held in elvish hand, pure white light dispelling darkness, phial of galadriel style, tolkien fantasy luminous painting',
    tags: ['abjuración', 'luz', 'anti-oscuridad', 'élfico'],
  },
  {
    slug: 'cancion-de-poder', name: 'Canción de Poder', lore: 'LOTR', loreName: 'Tierra Media',
    level: 4, school: 'Encantamiento', castingTime: '1 acción (concentración)', range: '60 pies', duration: 'Concentración, hasta 1 minuto',
    description: 'El lanzador entona una melodía antigua que teje magia en cada nota, como hicieron Finrod y Sauron en su duelo de canciones. La canción puede inspirar aliados, debilitar enemigos o alterar la realidad.',
    ...
    imagePrompt: 'elf singing a song of power, musical notes turning into golden light, ancient forest setting, magical aura, tolkien fantasy art',
    tags: ['encantamiento', 'buff', 'debuff', 'concentración', 'élfico'],
  },
  {
    slug: 'curacion-elfica', name: 'Curación Élfica', lore: 'LOTR', loreName: 'Tierra Media',
    level: 2, school: 'Evocación', castingTime: '1 acción', range: 'Toque', duration: 'Instantáneo',
    description: 'Usando el conocimiento curativo de los Eldar, el lanzador coloca sus manos sobre las heridas y canaliza la vitalidad de Arda. Hojas de athelas brillan con luz tenue mientras el cuerpo sana.',
    effects: ['Cura 3d8+WIS HP al objetivo tocado', 'Remueve una condición: envenenado, enfermo o cegado', 'Si se usan hojas de athelas como componente, cura 2d8 adicionales'],
    imagePrompt: 'elven healer with glowing hands over a wound, athelas leaves shining, soft golden light, peaceful forest, tolkien fantasy oil painting',
    tags: ['curación', 'restauración', 'toque', 'élfico'],
  },
  {
    slug: 'maldicion-de-morgul', name: 'Maldición de Morgul', lore: 'LOTR', loreName: 'Tierra Media',
    ...
    effects: ['El objetivo recibe 4d8 daño necrótico', 'CD 16 CON o el objetivo pierde 1d4 HP máximos por turno', 'Mientras esté maldito, el objetivo es visible para los Nazgûl', 'Solo removible con Curación Élfica nivel 4+ o magia equivalente'],
    damage: '4d8 necrótico',
    imagePrompt: 'dark morgul curse spreading from a wound, black veins glowing, victim in agony, shadowy spectral realm visible, tolkien dark fantasy',
    tags: ['nigromancia', 'maldición', 'daño-continuo', 'oscuro'],
  },
  {
    slug: 'escudo-runico', name: 'Escudo Rúnico', lore: 'LOTR', loreName: 'Tierra Media',
    ...
    imagePrompt: 'glowing dwarven runes forming a shield in the air, golden runic symbols, warrior behind magical barrier, tolkien fantasy art, dramatic',
    tags: ['abjuración', 'defensa', 'reacción', 'enano'],
  },
  {
    slug: 'invocar-aguilas', name: 'Invocar Águilas', lore: 'LOTR', loreName: 'Tierra Media',
    ...
    imagePrompt: 'great eagles of manwe descending from mountain peaks, massive wingspan, golden sunlight, epic tolkien fantasy painting, majestic birds',
...
// Hechizos de Star Wars
const STARWARS_SPELLS: Spell[] = [
  {
    slug: 'empujon-de-fuerza', name: 'Empujón de Fuerza', lore: 'STAR_WARS', loreName: 'Star Wars',
    level: 1, school: 'La Fuerza (Telekinesis)', castingTime: '1 acción', range: '60 pies', duration: 'Instantáneo',
    description: 'Extendés la mano y canalizás la Fuerza para empujar a un enemigo con violencia. Los objetos salen volando, los enemigos son lanzados hacia atrás y las paredes se agrietan.',
    ...
    damage: '2d8 fuerza',
    imagePrompt: 'jedi using force push, energy wave from extended hand, enemy flying backwards, debris in air, star wars cinematic lighting',
    tags: ['telekinesis', 'control', 'fuerza', 'lado-luminoso'],
  },
  {
    slug: 'truco-mental-jedi', name: 'Truco Mental Jedi', lore: 'STAR_WARS', loreName: 'Star Wars',
    level: 2, school: 'La Fuerza (Control Mental)', castingTime: '1 acción', range: '30 pies', duration: '1 minuto',
    description: 'Con un sutil movimiento de la mano, implantás una sugerencia en la mente del objetivo. "Estos no son los droides que buscan." Solo funciona en mentes débiles.',
    ...
    imagePrompt: 'jedi performing mind trick, subtle hand wave, confused stormtrooper, star wars setting, cinematic blue lighting',
    tags: ['control-mental', 'social', 'fuerza', 'lado-luminoso', 'sutil'],
  },
  {
    slug: 'estrangulamiento', name: 'Estrangulamiento (Dark Side)', lore: 'STAR_WARS', loreName: 'Star Wars',
    level: 3, school: 'La Fuerza (Lado Oscuro)', castingTime: '1 acción (concentración)', range: '60 pies', duration: 'Concentración, hasta 1 minuto',
    description: 'Cerrás el puño y la Fuerza aprieta la garganta del objetivo. Un poder del Lado Oscuro que corrompe a quien lo usa, pero es devastadoramente efectivo contra un solo enemigo.',
    ...
    imagePrompt: 'sith lord force choking victim, raised clenched fist, dark side red energy, victim levitating and gasping, star wars dark cinematic',
    tags: ['lado-oscuro', 'control', 'concentración', 'daño-continuo', 'corrupción'],
  },
  {
    slug: 'deflectar-blaster', name: 'Deflectar Blaster', lore: 'STAR_WARS', loreName: 'Star Wars',
    level: 0, school: 'La Fuerza (Combate)', castingTime: 'Reacción', range: 'Personal', duration: 'Instantáneo',
    description: 'Usando la Fuerza y tu sable de luz, deflectás un disparo de blaster. Con suficiente habilidad, podés redirigir el tiro de vuelta al atacante.',
    effects: ['Reduce el daño de un ataque a distancia en 1d10+DEX+nivel', 'Si el daño se reduce a 0, podés redirigir el disparo a un objetivo a 60 pies', 'El ataque redirigido usa tu modificador de Fuerza', 'Requiere sable de luz o similar'],
    imagePrompt: 'jedi deflecting blaster bolt with lightsaber, green blade, energy reflection, dynamic action pose, star wars cinematic',
    tags: ['combate', 'defensa', 'reacción', 'sable-de-luz'],
  },
  {
    slug: 'vision-de-la-fuerza', name: 'Visión de la Fuerza', lore: 'STAR_WARS', loreName: 'Star Wars',
    level: 3, school: 'La Fuerza (Percepción)', castingTime: '10 minutos (meditación)', range: 'Ilimitado', duration: 'Instantáneo',
    description: 'En meditación profunda, la Fuerza te muestra visiones del futuro, fragmentos de lo que fue y lo que podría ser. Las visiones son crípticas y siempre están en movimiento.',
    ...
    imagePrompt: 'jedi meditating with force visions, swirling images of future events, ethereal blue glow, star wars mystical scene',
    tags: ['percepción', 'adivinación', 'ritual', 'narrativo'],
  },
  {
    slug: 'curacion-con-la-fuerza', name: 'Curación con la Fuerza', lore: 'STAR_WARS', loreName: 'Star Wars',
    level: 2, school: 'La Fuerza (Sanación)', castingTime: '1 acción', range: 'Toque', duration: 'Instantáneo',
    description: 'Colocás tus manos sobre la herida y canalizás la energía de la Fuerza para acelerar la curación natural. Un poder raro que pocos Jedi dominan, que transfiere vitalidad del sanador al herido.',
    ...
    imagePrompt: 'jedi healing with force, glowing hands over wound, golden light transfer, peaceful expression, star wars cinematic warm lighting',
    tags: ['sanación', 'curación', 'toque', 'lado-luminoso', 'sacrificio'],
  },
  {
    slug: 'rayo-de-fuerza', name: 'Rayo de Fuerza', lore: 'STAR_WARS', loreName: 'Star Wars',
    level: 5, school: 'La Fuerza (Lado Oscuro)', castingTime: '1 acción', range: '60 pies (línea)', duration: 'Instantáneo',
    description: 'Relámpagos azules brotan de tus dedos destruyendo todo a su paso. El arma definitiva de los Sith, capaz de derribar a los más poderosos guerreros. Su uso corrompe profundamente.',
    effects: ['Línea de 60 pies, todos deben tirar CD 17 DEX', 'Un sable de luz puede bloquear: reacción + CD 15 DEX para redirigir', 'El lanzador gana 2 puntos de Lado Oscuro', 'Puede sostenerse como acción en turnos siguientes por mitad de daño'],
    damage: '6d8 eléctrico',
    imagePrompt: 'sith force lightning from fingertips, blue-purple electric arcs, dark hooded figure, dramatic star wars dark side art',
...
export const SPELL_SCHOOL_ICONS: Record<string, string> = {
  ...
  'Adivinación': '👁️',
  'Supervivencia': '🩹',
  'La Fuerza (Telekinesis)': '🤚',
  'La Fuerza (Control Mental)': '🧠',
  'La Fuerza (Lado Oscuro)': '⚡',
  'La Fuerza (Combate)': '⚔️',
  'La Fuerza (Percepción)': '👁️',
  'La Fuerza (Sanación)': '💛',
  'Netrunning': '💻',
  'Implante': '🦾',
